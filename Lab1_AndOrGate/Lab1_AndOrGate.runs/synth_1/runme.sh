...
HD_PWD='C:/Users/bartu/DigitalDesign/Lab1_AndOrGate/Lab1_AndOrGate.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andOrGates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andOrGates.tcl
