...
HD_PWD='C:/Users/bartu/DigitalDesign/Lab2_Operators/Lab2_Operators.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log operators.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source operators.tcl
